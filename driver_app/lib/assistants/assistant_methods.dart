...
class AssistantMethods
{
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    totalFareAmount = totalFareAmount*60.0;
    ...
    else if(driverVehicleType == "vahan-mini")
    {
      return totalFareAmount.truncate().toDouble();
    }
    else if(driverVehicleType == "vahan-max")
    {
      double resultFareAmount = (totalFareAmount.truncate()) * 2.0;
      return resultFareAmount;
    }
  ...
  static void readDriverRatings(context){
        ...
        .then((snap)
    {
      ...
      {
        String driverEarnings = snap.snapshot.value.toString();
        Provider.of<AppInfo>(context, listen: false).updateDriverAverageRatings(driverEarnings);
      }
    });
